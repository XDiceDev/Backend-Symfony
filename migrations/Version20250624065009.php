 ...
 */
final class Version20250624065009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE booking CHANGE comment comment VARCHAR(255) DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE booking CHANGE comment comment LONGTEXT DEFAULT NULL
        SQL);
    }
}
